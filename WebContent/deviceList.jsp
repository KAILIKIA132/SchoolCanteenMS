			...
			<ul>
				<li>
					...
					<ul>
						...
						<%-- <li><a href="#" onclick="operateDevice('syncTimeZone')" ><s:text name="device.operate.syncTimeZone"/></a></li> --%>	
						<li><a href="#" id="syncTimeZoneOpen" onclick="location.href='javascript:void()'"><s:text name="device.operate.syncTimeZone"/></a></li>		
					</ul>
				</li>
				<li>
