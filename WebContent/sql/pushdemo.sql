...
CREATE TABLE `device_info` (
  ...
  `DEVICE_SN` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `bioData_Stamp` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `idCard_Stamp` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `errorLog_Stamp` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
...
set sqlstr ='select device_id , device_sn , device_name, alias_name, dept_id, 
							...
							(select count(*) from pers_bio_template where DEVICE_SN=a.device_sn and bio_type=9 and template_no=0) act_face_count,
							
							(select count(*) from att_log where device_sn=a.device_sn) act_att_count, mask, temperature, bioData_Stamp,
							idCard_Stamp, errorLog_Stamp
