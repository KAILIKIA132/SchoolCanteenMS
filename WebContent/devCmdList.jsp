				...
				<div class="push_Search_box">
						...
						<div class="zk_nav">
							<ul id="jsddm">
								<li id="zkoperation_navMenu1">
									<a href="#">
										<s:text name="cmd.operate.items" />
									</a>
									<ul>
										<li><a href="#" onclick="operation('deleteSel')">
												<s:text name="cmd.operate.delete.selected" />
											</a></li>
										<li><a href="#" onclick="operation('deleteReturn')">
												<s:text name="cmd.operate.delete.all.return" />
											</a></li>
									</ul>
								</li>
							</ul>
					...
					<div class="l zk_Search">
						...
						<div class="zk_Search_bd l">
							<input class="input_sou" id="searchCommand" type="text" value='${byCommand}'
					...
					<table border="0" cellpadding="0" cellspacing="0" class="push_tab1">
						<tr>
							...
							<th>
								<s:text name="table.header.cmd.id" />
							</th>
							<th>
								<s:text name="table.header.cmd.device" />
							</th>
							<th>
								<s:text name="table.header.cmd.content" />
							</th>
							<th>
								<s:text name="cmd.header.cmd.commit.time" />
							</th>
							<th>
								<s:text name="cmd.header.cmd.trans.time" />
							</th>
							<th>
								<s:text name="cmd.header.cmd.return.time" />
							</th>
							<th>
								<s:text name="cmd.header.cmd.return.value" />
							</th>
							<th>
								<s:text name="table.header.cmd.return.info" />
							</th>
						</tr>
