...
'body,html{margin:0px;height:100%;background:#474848;}a,li,input {font-family:"Verdana","Arial";font-size:12px;}'+
'a {height:18px;color:#7ac142;padding-top:2px;text-decoration:none;display:block;}'+
'a:hover{height:17px;padding-top:2px;border:1px solid #;background:#d8eec7;}'+
'.CurrentDate {height:17px;padding-top:1px;background: #474848;}'+
...
'#Tools {width:206px;background:#7ac142;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#000;}'+
'#Tools a:hover{background:#d8eec7;}'+
'#Title {width:206px;border-bottom:0px solid #000;}'+
'#Title li{height:15px;padding-top:5px;background:#606262;}'+
'#sYear,#sMonth {width:50px;height:16px;border:1px solid #474848;border-right:0;padding-top:2px;}'+
'#SArr {width:19px;height:18px;background:#a2a7a7;font-size:10px;text-align:center;color:#474848;border:1px solid #474848;border-left:10;margin-right:3px;cursor:pointer;}'+
'#Select {width:64px;border:1px solid #474848;background:#474848;height:170px;}'+
'#Select a{height:16px;padding-left:3px;}'+
'#Select a:hover{color:#000;background:#d8eec7;padding-top:2px;border:0;}'+
'#Select #SelectBn {background:#0a2a7a7;font-size:8px;line-height:6px;height:6px;text-align:center;color:#7ac142;}'+
'#Select #SelectBn:hover{background:#7ac142;color:#FFF;}#SArr,#sYear,#sMonth{float:left;}'+
'#SelectYear,#SelectMonth{position:absolute;top:23px;z-index:1;overflow:hidden;display:none;}'+
'--></style><scr'+
...
'<div id="SelectYear" style="left:22px;" onclick="ShowSelect(\'SelectYear\',\'Y\');"><div id="Select"><a href="javascript:;" onmousedown="mdown=window.setInterval(\'Scroll(\\\'Up\\\',\\\'Y\\\')\',50);" onmouseup="window.clearInterval(mdown);" onmouseout="window.clearInterval(mdown);" id="SelectBn" style="border-bottom:1px solid #7ac142;"><font face="Webdings">&#53;</font></a><div id="SelectYearItem">'+
'</div><a href="javascript:;" onmousedown="mdown=window.setInterval(\'Scroll(\\\'Next\\\',\\\'Y\\\')\',50);" onmouseup="window.clearInterval(mdown);" onmouseout="window.clearInterval(mdown);" id="SelectBn" style="border-top:1px solid #7ac142;"><font face="Webdings">&#54;</font></a></div></div>'+
'<div id="SelectMonth" style="left:100px;" onclick="ShowSelect(\'SelectMonth\',\'M\');"><div id="Select"><a href="javascript:;" onmousedown="mdown=window.setInterval(\'Scroll(\\\'Up\\\',\\\'M\\\')\',50);" onmouseup="window.clearInterval(mdown);" onmouseout="window.clearInterval(mdown);" id="SelectBn" style="border-bottom:1px solid #7ac142;"><font face="Webdings">&#53;</font></a><div id="SelectMonthItem">'+
'</div><a href="javascript:;" onmousedown="mdown=window.setInterval(\'Scroll(\\\'Next\\\',\\\'M\\\')\',50);" onmouseup="window.clearInterval(mdown);" onmouseout="window.clearInterval(mdown);" id="SelectBn" style="border-top:1px solid #7ac142;"><font face="Webdings">&#54;</font></a></div></div>';
...
'ipt><div style="border:1px solid #474848;height:'+(64+21*Trn)+'px;"><ul>'+
'<li style="padding-left:19px;width:155px;background:#7ac142;padding-bottom:1px;" id="SelectArea"><div id="sYear" onclick="ShowSelect(\'SelectYear\',\'Y\');">'+year+'年</div><div id="SArr" onclick="ShowSelect(\'SelectYear\',\'Y\');"><font face="Webdings">&#54;</font></div>'+
...
content+='</li>'+
'<li style="background-color: #7ac142;"><a style="font-size: 14px;color: #474848;"href="javascript:parent.Calendar_hide();" >×</a></li></ul><div style="height:1px"></div>'+
'<div id="Tools"><ul>'+
...
else{content+='<li style="width:85px;"><a href="javascript:parent.Calendar_GetDate('+date.getFullYear()+','+(date.getMonth()+1)+','+date.getDate()+');">选择本日</a></li>';}
...
Calendar.style.height=60+26*Trn+'px';		//框架高度
