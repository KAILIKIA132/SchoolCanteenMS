# filepath: /school-canteen-ms-deploy/school-canteen-ms-deploy/scripts/update_existing_install.ps1
#requires -version 5.1
<#
.SYNOPSIS
    Updates an EXISTING School Canteen Management System installation with recent changes.
